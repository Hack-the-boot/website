    ...
    return (
        <div className="page">
           ...
           <span className="!font-bold">WIN.</span>
            ...
            {/* ================= ANIMATED DOWN ARROWS + CENTER TEXT ================= */}
                ...
                <div className="!flex !flex-col !items-center !gap-3 animate-bounce">
                    ...
                    <div className="!flex !items-center !gap-6">
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            strokeWidth="2"
                            stroke="url(#techGradient)" // this makes the stroke follow the gradient
                            className="w-8 h-8 !drop-shadow-[0_0_10px_rgba(59,130,246,0.5)]"
                        >
                            <defs>
