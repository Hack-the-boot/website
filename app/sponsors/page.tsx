        ...
        <main className="page">
            <motion.section className="mainPageContainer !px-4 sm:!px-6" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                ...
                <div className="!max-w-4xl !mx-auto !space-y-6 sm:!space-y-8">
                    {/* Event Information */}
                    <motion.div className="!rounded-2xl !p-5 sm:!p-8 !bg-[rgba(51,54,56,0.27)] !border !border-blue-500/20" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
                        <h2 className="!text-xl sm:!text-2xl !font-bold !text-white !mb-4 sm:!mb-6">{t.sponsors.aboutTitle}</h2>
                        <div className="!prose !prose-invert !text-gray-300 !space-y-3 sm:!space-y-4">
                            <p>
                    ...
                    {/* Why Sponsor */}
                    <motion.div className="!rounded-2xl !p-5 sm:!p-8 !bg-[rgba(51,54,56,0.27)] !border !border-blue-500/20" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }}>
                        <h2 className="!text-xl sm:!text-2xl !font-bold !text-white !mb-4 sm:!mb-6">{t.sponsors.whyTitle}</h2>
                    ...
                    {/* Our Team */}
                    <motion.div className="!rounded-2xl !p-5 sm:!p-8 !bg-[rgba(51,54,56,0.27)] !border !border-blue-500/20" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }}>
                        <h2 className="!text-xl sm:!text-2xl !font-bold !text-white !mb-4 sm:!mb-6">{t.sponsors.teamTitle}</h2>
                        <div className="!prose !prose-invert !text-gray-300 !space-y-3 sm:!space-y-4">
                    ...
                    {/* Contact Section */}
                    <motion.div className="!rounded-2xl !p-5 sm:!p-8 !bg-gradient-to-br !from-blue-500/10 !to-cyan-500/10 !border !border-blue-500/30" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.5 }}>
                        <div className="!text-center !space-y-6">
                            <div>
                                <h2 className="!text-2xl sm:!text-3xl !font-bold !text-white !mb-2 sm:!mb-3">{t.sponsors.contactTitle}</h2>
                                <p className="!text-gray-300 !max-w-2xl !mx-auto">{t.sponsors.contactDesc}</p>
                            </div>
                            <div className="!flex !flex-col !items-center !gap-3 sm:!gap-4">
                                <a href="mailto:sponsors@hacktheboot.it" className="!inline-flex !items-center !gap-3 !px-6 !py-3 sm:!px-8 sm:!py-4 !rounded-xl !bg-gradient-to-r !from-blue-500 !to-cyan-500 !text-white !font-bold !text-base sm:!text-lg !shadow-lg hover:!from-blue-600 hover:!to-cyan-600 !transition-all !duration-300 !transform hover:!scale-105">
                    ...
                    {/* Footer Note */}
                    <div className="!border-t !border-blue-500/20 !pt-4 sm:!pt-6 !text-center !text-sm !text-gray-400">
